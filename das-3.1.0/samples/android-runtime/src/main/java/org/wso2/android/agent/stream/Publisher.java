...
public class Publisher{
    ...
    private static void publishEvent(DataPublisher dataPublisher, String streamId) throws FileNotFoundException, SocketException, UnknownHostException {
        for (int did = 0; did < 10; did++) {
            String content = String.format("{\"packageName\":\"%s\",\"cpu\":%d,\"pid\":%d,\"pss\":%d,\"sharedDirty\":%d,\"uss\":%d}",
                    "com.want,vmc", RAND.nextInt(100), did+1000, RAND.nextInt(100), RAND.nextInt(100), RAND.nextInt(100));
